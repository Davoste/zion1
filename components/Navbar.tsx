        ...
        <div className="flex justify-between h-20">
          ...
          >
            ...
            <div className="flex flex-col">
              <span className="text-xl font-bold tracking-tight text-[#1e3a8a] serif leading-none">
                ZION HARVEST
              </span>
            ...
            {navLinks.map((link) => (
              <button
                ...
                className={`text-sm font-semibold transition-colors uppercase tracking-wider ${
                  activeTab === link.id
                    ? 'text-[#1e3a8a] border-b-2 border-red-600'
          ...
          {navLinks.map((link) => (
            <button
              ...
              className={`block w-full text-left px-6 py-4 rounded-xl text-lg font-bold ${
                activeTab === link.id
                  ? 'bg-blue-50 text-blue-900 border-l-4 border-red-600'
                  : 'text-slate-600'
              }`}
            >
              {link.name}
